...
public class AnalyticsQueryImpl implements AnalyticsQuery {
    ...
    public AnalyticsQueryImpl(EntityManager em) {
        this.em = em;
        qb = new QueryBuilder(em, EventImpl.class);
    }

    @Override
    public AnalyticsQuery after(long after) {
    ...
    @Override
    public AnalyticsQuery before(long before) {
        Root<EventImpl> root = qb.getRoot();
    ...
    @Override
    public AnalyticsQuery contextPath(String contextPath) {
        Root<EventImpl> root = qb.getRoot();
    ...
    @Override
    public AnalyticsQuery firstResult(int firstResult) {
    ...
    @Override
    public AnalyticsQuery maxResult(int maxResult) {
        qb.setMaxResult(maxResult);
        return this;
    }

    @Override
    public AnalyticsQuery page(String page) {
        Root<EventImpl> root = qb.getRoot();
